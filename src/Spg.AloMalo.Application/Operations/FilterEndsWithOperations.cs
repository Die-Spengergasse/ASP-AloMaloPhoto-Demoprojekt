...
{
    public class FilterEndsWithOperations : InterpretParameterBase<Photo>, IQueryParameter
    {
        private readonly IPhotoFilterBuilder _photoFilterBuilder;

        public FilterEndsWithOperations(IPhotoFilterBuilder photoFilterBuilder)
            : base("ew")
        {
