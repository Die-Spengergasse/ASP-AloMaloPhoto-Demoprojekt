...
public class EndsWithFilter<T> : IFilterOperation<T>
{
    ...
    {
        return items.Where(item => GetPropertyValue(item, _propertyName).EndsWith(_value, StringComparison.OrdinalIgnoreCase));
    }
