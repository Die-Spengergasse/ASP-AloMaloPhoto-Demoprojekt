...
namespace Spg.AloMalo.Application.Services.PhotoUseCases.Query
{
    public class GetPhotoFilter
    {
        ...
        public GetPhotoFilter(IPhotoFilterBuilder photoFilterBuilder, string propertyName, string value)
        {
        ...
        public IPhotoFilterBuilder get(string operation)
        {
