...
namespace Spg.AloMalo.MockMvc
{
    public class TestWebApplicationFactory : WebApplicationFactory<Program>
    {
        ...
        protected override void ConfigureWebHost(IWebHostBuilder builder)
        {
            ...
            {
                var descriptor = services.First(d => d.ServiceType == typeof(DbContextOptions<PhotoContext>));
        ...
        public void InitializeDatabase(Action<PhotoContext> action)
        {
            using var scope = Services.CreateScope();
            using var db = scope.ServiceProvider.GetRequiredService<PhotoContext>();
